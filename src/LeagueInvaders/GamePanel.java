...
public class GamePanel extends JPanel implements ActionListener, KeyListener {
	...
	GamePanel() {
		...
		try {
			...
			projectileImg = ImageIO.read(this.getClass().getResourceAsStream("bullet.png"));
			rocketshipImg = ImageIO.read(this.getClass().getResourceAsStream("rocketship.png"));
			spaceImg = ImageIO.read(this.getClass().getResource("space.png"));
	...
	void drawEndState(Graphics g) {
		...
		g.setFont(subtitleFont);
		g.drawString("You Killed (some) Enemies", 30, 400);
